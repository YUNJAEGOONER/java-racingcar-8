...
public class ExceptionCode {
  ...
  public static final String PLAYER_NAME_LENGTH_LIMIT = "플레이어의 이름은 1글자 이상 5글자 이하이어여 합니다.";

  public static final String INPUT_TURN_NOT_BLANK = "게임을 플레이할 횟수를 입력해 주세요(공백은 허용되지 않습니다.)";
  public static final String INPUT_TURN_NUMBER_FORMAT = "0으로 시작하지 않는 양의 정수를 입력해 주세요";
